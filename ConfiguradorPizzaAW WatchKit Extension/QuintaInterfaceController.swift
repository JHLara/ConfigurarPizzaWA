//
//  QuintaInterfaceController.swift
//  ConfiguradorPizzaAW
//
...
class QuintaInterfaceController: WKInterfaceController {
    ...
    func cargarTabla(){
        let datos = datosPizza.generaResumen()
        myTable.setNumberOfRows(datos.count, withRowType: "quintaTable")
    ...
    @IBAction func editar() {
        self.pushControllerWithName("primera", context: datosPizza)
    }
